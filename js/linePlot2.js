var LinePlot2 = {
	...
	xAxisGroup: null,
	yAxisGroup: null,
	points: [[1,4],[2,8],[3,5],[4,9],[5,13],[6,1],[7,15],[8,4],[9,6],[10,7],[11,19],[12,11]],
	line: null,
	path: null,
	markers: null,
	labels: null,
	show: function () {
		...
		this.line=d3.svg.line().x(function(d){ return LinePlot2.xAxisScale(d[0])}).y(function(d){return LinePlot2.yAxisScale(d[1])});
		...
		this.markers=this.svg.append("g").attr("id","markerGroup").selectAll("circle").data(this.points).enter().append("circle").attr(
		    {
		        cx: function(d){return LinePlot2.xAxisScale(d[0])},
		        cy: function(d){return LinePlot2.yAxisScale(d[1])},
		        r: 5,
		        fill: "magenta"
		    }).on("click",
		        function(d,i){
		...
		this.labels=this.svg.append("g").selectAll("text").data(this.points).enter().append("text").attr({
		        ...
		        x: function(d){return LinePlot2.xAxisScale(d[0])},
		        y: function(d){return LinePlot2.yAxisScale(d[1])}
		    }).text(
